...
interface HalPin<T> {
    ...
    companion object {
        ...
        @JvmStatic
        fun float(compName: String, name: String, dir: Dir) = FloatHalPin(compName, name, Type.FLOAT, dir)

        @JvmStatic
        fun s32(compName: String, name: String, dir: Dir) = IntHalPin(compName, name, Type.S32, dir)

//        @JvmStatic fun u32(name: String, dir: Dir, value: UInt) = HalPin(name, Type.U32, dir, value)
    }
}
