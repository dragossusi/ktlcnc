 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_init(JNIEnv* env
                                                                  , jobject thisObject) {
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setAuto(JNIEnv* env
                                                                     , jobject thisObject
                                                                     , jint    autoMode
                                                                     , jint    line) {
  int rv = 0;
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setBlockDelete(JNIEnv*  env
                                                                            , jobject  thisObject
                                                                            , jboolean enable) {
 ...
 * Signature: (D)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setFeedOverride(JNIEnv* env
                                                                             , jobject thisObject
                                                                             , jdouble rate) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setFlood(JNIEnv*  env
                                                                      , jobject  thisObject
                                                                      , jboolean enable) {
  if (enable) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setMist(JNIEnv*  env
                                                                     , jobject  thisObject
                                                                     , jboolean enable) {
  if (enable) {
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setOptionalStop(JNIEnv*  env
                                                                             , jobject  thisObject
                                                                             , jboolean enable) {
 ...
 * Signature: (D)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setRapidOverride(JNIEnv* env
                                                                              , jobject thisObject
                                                                              , jdouble rate) {
 ...
 * Signature: (ZI)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setSpindle(JNIEnv*  env
                                                                        , jobject  thisObject
                                                                        , jboolean enable
                                                                        , jint     speed
                                                                        , jint     direction) {
 ...
 * Signature: (D)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setSpindleOverride(JNIEnv* env
                                                                                , jobject thisObject
                                                                                , jdouble rate) {
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setTaskMode(JNIEnv* env
                                                                         , jobject thisObject
                                                                         , jint    mode) {
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_setTaskState(JNIEnv* env
                                                                          , jobject thisObject
                                                                          , jint    state) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_mindovercnc_linuxcnc_CommandWriter_taskAbort(JNIEnv* env
                                                                       , jobject thisObject) {
  EMC_TASK_ABORT ta;
