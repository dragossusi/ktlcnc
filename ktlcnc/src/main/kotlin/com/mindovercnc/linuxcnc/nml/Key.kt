...
/**
 * The text description of the keys must match the keys that are being output by running ./DumpBufDesc
 * If the keys do match, we can check the offsets of a linuxcnc versions to make sure they are correct.
 */
